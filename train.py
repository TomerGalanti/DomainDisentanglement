    ...
    while True:
        ...
        for domA_img, domB_img in zip(domA_loader, domB_loader):
            ...
            if _iter % args.display_iter == 0:
                ...
                save_imgs(args, e_common, e_separate_A, e_separate_B, decoder, _iter, BtoA=True)
                save_imgs(args, e_common, e_separate_A, e_separate_B, decoder, _iter, BtoA=False)
                save_stripped_imgs(args, e_common, e_separate_A, e_separate_B, decoder, _iter, A=True)
                save_stripped_imgs(args, e_common, e_separate_A, e_separate_B, decoder, _iter, A=False)
